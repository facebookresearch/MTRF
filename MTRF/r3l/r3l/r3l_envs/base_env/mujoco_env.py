...
class MujocoEnv(gym.Env):
    ...
    def __init__(self, model_path=None, frame_skip=1, sim=None, seed=None):
        ...
        #     self.obs_dim = np.sum([obs.size for obs in observation.values()])
        # elif isinstance(observation, tuple):
        #     self.obs_dim = np.sum([obs.size for obs in observation])
        # elif isinstance(observation, np.ndarray):
        #     self.obs_dim = observation.size
        # else:
        #     raise ValueError("Observation type is not supported. Use either"
        #                      "a flattened np.array, a dictionary of arrays, "
        #                      "or a tuple of observation array values.")
    ...
    def do_simulation(self, ctrl, n_frames):
        ...
        # TODO: Figure out what in the environment is causing the Mujoco errors.
